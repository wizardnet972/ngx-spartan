...
export class BrnSelectContentComponent {
  ...
  constructor() {
    this._cdkListbox.valueChange
      ...
      .subscribe((val: ListboxValueChangeEvent<unknown>) => {
    ...
    effect(() => {
      ...
      // setTimeout(() => {
      //   (this._cdkListbox as any).selectionModel.selected.forEach((value) => {
      //     (this._cdkListbox as any).selectionModel.deselect(value);
      //   });
      // });
    });
  }
